# Generated by Django 2.2 on 2021-08-16 15:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('billing_Cycle', models.CharField(choices=[('-----', '-----'), ('Daily', 'Daily'), ('Weekly', 'Weekly'), ('Monthly', 'Monthly')], default='-----', max_length=100)),
                ('payment_mode', models.CharField(choices=[('-----', '-----'), ('Mpesa', 'Mpesa'), ('Bank', 'Bank'), ('Cash', 'Cash')], default='-----', max_length=50)),
