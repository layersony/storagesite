# Generated by Django 2.2 on 2021-08-12 11:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('billing_Cycle', models.CharField(choices=[('Daily', 'Daily'), ('Weekly', 'Weekly'), ('Monthly', 'Monthly')], default='Monthly', max_length=100)),
                ('payment_mode', models.CharField(choices=[('Mpesa', 'Mpesa'), ('Bank', 'Bank'), ('Cash', 'Cash')], default='Mpesa', max_length=50)),
